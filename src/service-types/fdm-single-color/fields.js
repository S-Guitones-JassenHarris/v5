// src/service-types/fdm-single-color/fields.js

// Field configuration for FDM Single Color service

export const fdmSingleColorFields = [
  // --- Print time ---
  ...
  // Printer brand (from machines catalog, distinct brands)
  {
    id: 'printerBrand',
    label: 'Printer brand',
    inputType: 'select',
  ...
  },
  {
    ...
    inputType: 'number',
    required: false,
    placeholder: 'Handling per batch in minutes, default is 10 minutes',
    updateOn: 'blur',
  },
  {
  ...
  },
  {
    ...
    inputType: 'number',
    required: false,
    placeholder: 'default = Total print time × 5 , hard minimum cap of 3 days',
    updateOn: 'blur',
  },
  {
    id: 'miscCosts',
  ...
  },
  {
    ...
    inputType: 'text',
    required: false,
    placeholder: 'e.g. Custom FDM Prototype',
    updateOn: 'blur',
  },
  {
  ...
  },
  {
    ...
    inputType: 'text',
    required: false,
    placeholder: 'e.g. Special PLA Blend',
    updateOn: 'blur',
  },
  {
