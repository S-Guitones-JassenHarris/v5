// src/service-types/resin-printing/fields.js

// Field configuration for Resin Printing (SLA) service

export const resinPrintingFields = [
  // --- Print time ---
  ...
  // Printer brand (from machines catalog, distinct brands, RESIN machines)
  {
    id: 'printerBrand',
    label: 'Printer brand',
    inputType: 'select',
    catalogId: 'machines',
    filterJobTypeValue: 'Resin printing', // matches machines.job_type
  ...
  // Printer (specific machine, RESIN)
  {
    id: 'printerMachineId',
    label: 'Printer',
    inputType: 'select',
  ...
  // Material type (SLA Printing materials)
  {
    id: 'materialType',
    label: 'Material type',
    inputType: 'select',
    catalogId: 'materials',
    filterJobTypeValue: 'SLA Printing', // matches materials.Job_type
  ...
  },
  {
    ...
    inputType: 'text',
    required: false,
    placeholder: 'e.g. Custom SLA Prototype',
    updateOn: 'blur',
  },
  {
  ...
  },
  {
    ...
    inputType: 'text',
    required: false,
    placeholder: 'e.g. Special Resin Blend',
    updateOn: 'blur',
  },
  {
  ...
  {
    id: 'customMaterialDensity',
    label: 'Custom material density (g/ml)',
    inputType: 'number',
    required: false,
    placeholder: 'Density used for volume → kg',
    updateOn: 'blur',
  },
  {
    ...
    inputType: 'text',
    required: false,
    placeholder: 'e.g. Standard, ABS-like, Dental',
    updateOn: 'blur',
  },
];
