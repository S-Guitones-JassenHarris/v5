// src/service-types/resin-printing/calculator.js

// Real calculator for Resin Printing (SLA) service
...
export function calculateResinPrintingQuote(inputs = {}, catalogs = {}) {
  ...
  const printVolumeMl = toNumber(inputs.printVolumeMl, 0);
  ...
  if (isCustomMaterial) {
    ...
    materialAdjustedPricePerKg = selectedMaterial
      ...
      : 0;
    materialDensityGPerMl = selectedMaterial
      ? toNumber(selectedMaterial.density_g_per_ml, 1)
      : 1;
  }
  ...
  // --- Test prints with profit (same new logic) ---
  //
